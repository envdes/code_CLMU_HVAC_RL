...
! JJ 2024/10/12 RL
     real(r8), pointer :: ac_set_point_lun         (:)   ! lun air conditioning set point temperature (K)
     real(r8), pointer :: heat_set_point_lun       (:)   ! lun heating set point temperature (K)
     real(r8), pointer :: vent_ach_lun             (:)   ! lun ventilation air change rate (1/hr)
! JJ 2024/10/12 RL
...
! JJ 2024/10/12 RL
    allocate(this%ac_set_point_lun         (begl:endl))                      ; this%ac_set_point_lun         (:)   = nan
    allocate(this%heat_set_point_lun       (begl:endl))                      ; this%heat_set_point_lun       (:)   = nan
    allocate(this%vent_ach_lun             (begl:endl))                      ; this%vent_ach_lun             (:)   = nan
! JJ 2024/10/12 RL
...
! JJ 2024/10/12 RL
    this%ac_set_point_lun(begl:endl) = spval
    call hist_addfld1d (fname='AC_SET_POINT', units='K',  &
         avgflag='A', long_name='Air conditioning set point temperature', &
         ptr_lunit=this%ac_set_point_lun, set_spec=spval, default='inactive')    

    this%heat_set_point_lun(begl:endl) = spval
    call hist_addfld1d (fname='HEAT_SET_POINT', units='K',  &
         avgflag='A', long_name='Heating set point temperature', &
         ptr_lunit=this%heat_set_point_lun, set_spec=spval, default='inactive')    

    this%vent_ach_lun(begl:endl) = spval
    call hist_addfld1d (fname='VENT_ACH', units='1/hr',  &
         avgflag='A', long_name='Ventilation air change rate', &
         ptr_lunit=this%vent_ach_lun, set_spec=spval, default='inactive')
! JJ 2024/10/12 RL
...
!JJ
    this%t_ssbef_col(begc:endc,:) = spval
    call hist_addfld2d (fname='TSSBF',  units='K', type2d='levgrnd', &
         avgflag='A', long_name='TSSBF', &
         ptr_col=this%t_ssbef_col, l2g_scale_type='veg')
!JJ
...
! JJ 2024/10/12 RL
          this%ac_set_point_lun(l) = 298.15_r8
          this%heat_set_point_lun(l) = 288.15_r8
          this%vent_ach_lun(l) = 0.3_r8
! JJ 2024/10/12 RL
          end if
       end if
    end do
...
! JJ 2024/10/12 RL
     call restartvar(ncid=ncid, flag=flag, varname='AC_SET_POINT', xtype=ncd_double, dim1name='landunit',              &
           long_name='air conditioning set point temperature', units='K',                                               &
           interpinic_flag='interp', readvar=readvar, data=this%ac_set_point_lun)

     call restartvar(ncid=ncid, flag=flag, varname='HEAT_SET_POINT', xtype=ncd_double, dim1name='landunit',            &
               long_name='heating set point temperature', units='K',                                                      &
               interpinic_flag='interp', readvar=readvar, data=this%heat_set_point_lun)

     call restartvar(ncid=ncid, flag=flag, varname='VENT_ACH', xtype=ncd_double, dim1name='landunit',                  &
               long_name='ventilation air changes per hour', units='1/hour',                                             &
               interpinic_flag='interp', readvar=readvar, data=this%vent_ach_lun)
! JJ 2024/10/12 RL
